...
#pragma warning restore RCS1158 // Static member in generic type should use a type parameter.
        ...
        private static void AddLogChannel(ISocketMessageChannel c, ulong cid)
        {
            ...
            static string GetMessage(PokeRoutineExecutorBase bot, PokeTradeDetail<T> detail) => $"> [{DateTime.Now:hh:mm:ss}] - {bot.Connection.Label} est maintenant en train d'échanger avec {detail.Trainer.TrainerName} (ID {detail.ID})";
